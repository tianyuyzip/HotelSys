...
<html>
  ...
  <body>
     <h3>[<s:property value="hotel.hotelName"/>]分店信息修改</h3>
     <s:form namespace="/hotel" action="updateHotel" method="post" enctype="multipart/form-data">
        ...
        <img id="hotelPreview" style="margin-left:80px;" width="200" height="120" 
           src="<s:url namespace="/hotel" action="loadHotelPic"/>?hotel.hotelNo=<s:property value="hotel.hotelNo"/>">
        <div>
          <label>分店图片:</label>
